...
// Allowed output roots come from path-guard.defaultApifierAllowedRoots so the
// generate-side and mapping/write-side stay in sync.
function _buildAllowedRoots() {
  return defaultApifierAllowedRoots();
}

...
/**
 * Sniff the first 512 bytes of a body to determine if it's HTML, Markdown, or OpenAPI.
 * Returns 'html' | 'markdown' | 'openapi'.
 * @param {string} body
...
async function handleScrape(params) {
  ...
  // Determine whether to use HTML, Markdown, or OpenAPI parser.
  let sniffedType;
  if (sourceType === 'html') {
    sniffedType = 'html';

...
// Wave 4A ships `ts-fetch`; others return not_supported_yet.

const TS_FETCH = require('./ts-fetch');

const TARGETS = {
  'ts-fetch':        { generate: TS_FETCH.generate, ext: '.ts',   wave: '4A' },
  'ts-axios':        { generate: null,              ext: '.ts',   wave: '4B' },
  'python-requests': { generate: null,              ext: '.py',   wave: '4B' },
  'python-httpx':    { generate: null,              ext: '.py',   wave: '4C' },
  'go-net-http':     { generate: null,              ext: '.go',   wave: '6+' },
  'curl-shell':      { generate: null,              ext: '.sh',   wave: '6+' },
  'openapi-3.1':     { generate: null,              ext: '.yaml', wave: '4B' },
};

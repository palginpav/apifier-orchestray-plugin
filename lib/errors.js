...
/** GraphQL SDL failed to parse (too short, no root types, malformed SDL). Sub-class of ParserError. Maps to -32013. */
class GraphQLParseError extends ParserError {
  constructor(message) {
    super(message);
...
/** apifier-watch failed during scrape or baseline-load phase. Maps to -32014. */
class WatchError extends ApifierError {
  constructor(message) {
    super(message);
